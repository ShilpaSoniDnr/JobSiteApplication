...
function InterviewModel({showInterviewModal, handleCloseInterview, onSelectInterviewItem, onSelectInterviewSecItem, onSelectInterviewFinItem}) {
    ...
    const handleInterviewSecClick = (item) => {
        onSelectInterviewSecItem(item.DisplayName); // Assuming 'Name' is the field to set in input
         
    };
    const handleInterviewFinClick = (item) => {
        onSelectInterviewFinItem(item.DisplayName); // Assuming 'Name' is the field to set in input
